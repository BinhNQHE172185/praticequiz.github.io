...
<div class="page-wraper">
	...
	<!-- Header Top ==== -->
        <jsp:include page="header.jsp"/>    <!-- header END ==== -->
    <!-- Inner Content Box ==== -->
				...
				<div class="container">
					<div class="row align-items-center d-flex">
						<div class="col-lg-5 col-md-12 heading-bx">
							<h2 class="m-b10">Introduction</h2>
							<h5 class="fw4">An interesting web</h5>
							<p>Welcome to our Quiz Practice Web, your one-stop destination for honing your knowledge and testing your skills in a fun and engaging way. Whether you're preparing for exams, brushing up on a subject, or simply looking for an enjoyable challenge, our platform has you covered. With a diverse range of quizzes spanning various topics and difficulty levels, you can tailor your learning experience to suit your needs. Get ready to embark on a journey of learning and self-improvement as you explore our quiz practice web. Let's start quizzing!</p>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="join-content-bx text-white">
								...
								<p>
Are you ready to take your learning to the next level? Register today and embark on an exciting journey of knowledge discovery. By signing up, you'll gain access to our vast collection of quizzes covering a wide range of subjects and skill levels. Whether you're a student looking to excel in exams or an enthusiast eager to expand your horizons, our platform provides the perfect practice environment. Join our community of learners, track your progress, and start sharpening your skills right away. Don't miss this chance to enhance your expertise – register now and seize the opportunity to learn and grow!</p>
                                ...
                                <div class="item">
                                    <div class="testimonial-bx">
                                        ...
                                        <div class="testimonial-content">
                                            <p>I'm over 20 years old and have never seen a website as good as this one,It has helped me study easier in every subject. Wonderful!</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="testimonial-bx">
                                        ...
                                        <div class="testimonial-content">
                                            <p>This website has helped me get to where I am today. I can easily practice and improve more and more in my subjects just thanks to this website. Brilliant!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
