                            ...
                            <ul>	<!-- SLIDE  -->
                                <li data-index="rs-100" 
                                    ...
                                    <div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
                                        ...
                                        Welcome to our quiz practice website, your ultimate destination for honing your knowledge and skills through engaging quizzes. 
                                    </div>
                                    <!-- LAYER NR. 4 -->
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="service-bx m-b0">
                                        ...
                                        <div class="info-bx text-center">
                                            ...
                                            <h4><a href="#">Join us now</a></h4>
                                            <a href="register.html" class="btn radius-xl">View More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
